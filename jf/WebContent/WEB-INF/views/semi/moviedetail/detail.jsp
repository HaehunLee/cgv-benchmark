...
<link rel="stylesheet" href="/jf/resources/bootstrap/css/moviedetail.css">
...
<body>
	...
	<div class="container">
		...
		<div class="row detail_main_row">
			<div class="col-sm-3">
				<a target="blank" href="/jf/photos/movieposters/${movie.poster }"><img class="detail_2_movieposter"
					src="/jf/photos/movieposters/${movie.poster }" alt=""></a>
			</div>
			<div class="col-sm-9">
				<div class="row">
					<div class="col-sm-12">
						<span class="detail_2_korTitle">${movie.korTitle }</span> <span class="detail_2_nowShowing"> <img src="/jf/photos/NowShowing.PNG" alt="" />
						</span>
					</div>
				</div>
